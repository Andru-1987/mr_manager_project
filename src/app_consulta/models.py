...
class Consulta(models.Model):
    usuario_consulta = models.ForeignKey(ManagerUser, on_delete=models.CASCADE, related_name='consultas_realizadas')
    receptor_consulta = models.ForeignKey(ManagerUser, on_delete=models.CASCADE, related_name='consultas_recibidas', limit_choices_to={'staff': True})
...
class ArchivoConsulta(models.Model):
    ...
    class Meta:
        db_table = "app_consulta_archivos_consulta"
